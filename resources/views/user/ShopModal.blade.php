                                  ...
                                  <div id="myCarousel" class="carousel slide" data-ride="carousel" >
                                    ...
                                    <div class="carousel-inner"  >
                                      <div class="carousel-item active">
                                          <img width="100%" id="image_1" src="" alt="New York" width="1100px" height="400px" style="height: 500px!important;">
                                      </div>
                                      <div class="carousel-item">
                                        <img width="100%" id="image_2" src="" width="1100px" height="400px" style="height: 500px!important;">
                                      </div>
                                      <div class="carousel-item">
                                        <img width="100%" id="image_3" src="" alt="New York" width="1100px" height="400px" style="height: 500px!important;">
                                      </div>
                                    </div>
